                        ...
                        <div class="list-content">
                            <div class="main-img list-img t-list-img">
                                <a href="tour-detail-right-sidebar.html">
                                    <img src="<c:url value="/resources/images/${item.images}"/>"  class="img-responsive" alt="tour-img" href="/home/detailtour/${item.maTour}" />
                                </a>
                                <div class="main-mask">
                                    <ul class="list-unstyled list-inline offer-price-1">
                                        <li class="price">${item.giaNguoilon}VNĐ/một người lớn<span class="divider">${item.viewTinh}</span></li>
                                        <li class="rating">
                            ...
                            <div class="list-info t-list-info">
                                <h3 class=""><a href="/home/detailtour/${item.maTour}">${item.tenTour}</a></h3>
